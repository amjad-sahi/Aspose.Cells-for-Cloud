...
UploadFileBinary(
    ...
    function (response) {
        ...
        var method = "POST";
        var request_url = "cells/"+input_file+"/worksheets/Sheet1/cells/rows/copy?sourceRowIndex=1&destinationRowIndex=6&rowNumber=1";
                ...
                console.log(JSON.stringify(response, null, 2));
                        ...
                        ProcessCommandContent(
                            ...
                            function (buffer) {
                                ...
                                console.log('Row copied:'+ outputPath);
