...
UploadFileBinary(
    ...
    function (response) {
        ...
        var imgmethod = 'PUT';
        var imgrequest_url = 'storage/file/' + 'picture.png';
        var imginput_file = 'picture.png';
        var imginput_path = getPath(__filename, imginput_file);
        var imgbuffer = fs.readFileSync(imginput_path);
        ...
        UploadFileBinary(
            ...
            function (response) {
                if (response.Status == 'OK') {
                    console.log(imginput_path, 'has been uploaded');

                }
                var method = "PUT";
                var request_url = "cells/" + input_file + "/worksheets/Sheet1/pictures?upperLeftRow=5&upperLeftColumn=5&lowerRightRow=20&lowerRightColumn=20&picturePath=" + imginput_file;
