...
Namespace Aspose.Cells.Cloud.Examples.PivotTables
	Friend Class AddPivotFieldInPivottable
		Shared Sub Main()
			...
			Dim pivotTableFieldRequest As New PivotTableFieldRequest()
			pivotTableFieldRequest.Data = New System.Collections.Generic.List(Of Integer)()
