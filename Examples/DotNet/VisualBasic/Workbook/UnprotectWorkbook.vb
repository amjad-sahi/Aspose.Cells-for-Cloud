...
Namespace Aspose.Cells.Cloud.Examples.Workbook
	Friend Class UnprotectWorkbook
		Shared Sub Main()
			...
			Common.CellsService.Worksheets.UnprotectWorksheet(input, "Sheet1", cellsProtectParameter, Common.FOLDER, storage:= Common.STORAGE)
