...
Namespace Aspose.Cells.Cloud.Examples.Charts
	Friend Class UpdateChartLegend
		Shared Sub Main()
			...
			Dim cellsChartLegendResponse As CellsChartLegendResponse = Common.CellsService.Charts.GetChartLegend(input, sheetName, 0, Common.FOLDER)
