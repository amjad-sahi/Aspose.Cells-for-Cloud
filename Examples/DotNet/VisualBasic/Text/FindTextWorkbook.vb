...
Namespace Aspose.Cells.Cloud.Examples.Text
	Friend Class FindTextWorkbook
		Shared Sub Main()
			...
			Dim apiResponse As CellsTextItemsResponse = Common.CellsService.Workbook.SearchText(input, text, Common.FOLDER, storage:= Common.STORAGE)
